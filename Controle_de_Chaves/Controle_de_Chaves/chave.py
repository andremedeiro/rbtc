...
class Chave:
    ...
    def __str__(self):
        if self.usuario_retirada == '-':
            ...
            return ("\n| " + self.local + " | " + self.usuario_retirada + ' | ' + self.data_retirada + ' | ' + self.hora_retirada + ' |')
        else:
            return ("\n| " + self.local + " | " + self.usuario_retirada + ' | ' + self.data_retirada + ' | Retirada: ' + self.hora_retirada  + ' | Entregue: ' + self.hora_entrega + ' | ' + self.data_entrega + ' | Desvolvedor: ' + self.usuario_entrega + ' |')
